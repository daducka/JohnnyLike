    ...
    public void AddCandidates(IslandContext ctx, SupplyPile pile, List<ActionCandidate> output)
    {
        ...
        output.Add(new ActionCandidate(
            ...
            EffectHandler: (Action<EffectContext>)(effectCtx =>
            {
                ...
                effectCtx.Actor.Satiety += MetabolismMath.CaloriesToSatietyDelta(MetabolismMath.CookedFishKcal);
                effectCtx.Actor.Morale  += 5.0;
                effectCtx.Actor.Energy  += MetabolismMath.CaloriesToEnergyDelta(MetabolismMath.CookedFishKcal * 0.05);
