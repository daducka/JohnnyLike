...
public class HumanActorState : LivingActorState, IIslandActionCandidate
{
    ...
    private void AddDownedCandidates(IslandContext ctx, List<ActionCandidate> output)
    {
        ...
        output.Add(new ActionCandidate(
            ...
            Qualities: new Dictionary<QualityType, double>(),
            ActorRequirement: actor => CandidateRequirements.IsSelf(Id)(actor) && CandidateRequirements.DownedOnly(actor)
        ));
    ...
    private void AddDeadCandidates(IslandContext ctx, List<ActionCandidate> output)
    {
        ...
        output.Add(new ActionCandidate(
            ...
            Qualities: new Dictionary<QualityType, double>(),
            ActorRequirement: actor => CandidateRequirements.IsSelf(Id)(actor) && CandidateRequirements.DeadOnly(actor)
        ));
    }
}
